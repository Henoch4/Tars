...
def send_alert(event: str, severity: str, detail: str) -> bool:
    ...
    try:
        ...
        # Failure must NOT stamp the cooldown table: a stamp-on-attempt
        # policy lets one transient webhook outage suppress a critical
        # kill-switch alert for the entire cooldown window.
